...
public class TeduEcommerceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public TeduEcommerceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
